...
export function ChatInput({
  ...
  return (
    <>
      <form className="flex flex-col gap-2 glass-card p-3 border-white/20 micro-card" onSubmit={handleSubmit}>
        {disabled ||
        uploadingImages ||
        isSubmitting ||
          ...
          <div className="flex flex-col md:flex-row flex-wrap gap-2">
            {suggestedFollowUps.map((prompt) => (
              <button
                ...
                className="w-10/12 md:w-auto px-3 py-1.5 text-sm rounded-full bg-secondary hover:bg-secondary/80 transition-all duration-200 text-left micro-button glow-accent hover:shadow-md shimmer"
              >
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Textarea
              ...
              className="flex-1 min-h-[40px] max-h-[200px] resize-none focus-ring glass-card border-white/20"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className="micro-button glow-accent transition-all duration-200 hover:shadow-md"
                >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    onClick={onReconnect}
                    variant="destructive"
                    className="flex items-center gap-2 micro-button glow-primary transition-all duration-200 hover:shadow-lg"
                  >
                    <span>Reconnect</span>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className="micro-button glow-primary transition-all duration-200 hover:shadow-lg pulse-glow"
                  >
