...
import { ModeAwareChat } from './components/ModeAwareChat';
    ...
    <div className="flex h-full bg-background">
      <div className="flex-1 flex flex-col">
        ...
        {isMobile ? (
          ...
          <div className="flex-1 flex flex-col">
            <div className={`flex-1 ${isPreviewOpen ? 'hidden' : 'block'}`}>
              <ModeAwareChat
                chat={chat}
            ...
            <div className={`flex-1 ${isPreviewOpen ? 'block' : 'hidden'}`}>
              <RightPanel
                onSendMessage={handleSendMessage}
